...
export const metadata: Metadata = {
  title: 'Дай [ ai ]',
  description:
    'Додатки та інструменти з використанням штучного інтелекту в наш час стають усе популярнішими. Тому пропонуємо сайт з пошуком найкращих іструметів для пошуку AI(ШІ).',
  openGraph: {
    title: 'Дай [ ai ]',
    description:
      'Додатки та інструменти з використанням штучного інтелекту в наш час стають усе популярнішими. Тому пропонуємо сайт з пошуком найкращих іструметів для пошуку AI(ШІ).',
